...
目标：搭好工具链、GitHub、PyTorch、基础代码习惯

### Phase 1：RL 机制感建立

目标：真正理解“Agent 如何通过交互学会变聪明”
...
| 阶段 | 时间建议 | 核心问题 | 产出 |
|---|---|---|---|
| Phase 0 | 现在-1周 | 工具和仓库怎么搭 | GitHub主仓库、开发环境 |
| Phase 1 | 2-3周 | RL 怎么学会策略 | Q-learning、CartPole实验报告 |
...
### 2. Python / PyTorch / Gymnasium 环境

你现在已经搞定了大半。后面统一用你现在的 RL 环境继续。
...
- Bellman 是什么
- Q-learning 是什么
- gamma / learning rate 会影响什么
- reward curve 为什么会抖

### 项目 1：FrozenLake / 自定义小环境的 Q-learning

类型：手搓

你要包含的内容：
- 自定义环境或 FrozenLake 环境
- 表格 Q-learning
- epsilon-greedy
- gamma / alpha 对比实验
- greedy policy 展示
...
- 为什么 Bellman 可以递归更新
- 为什么 gamma<1 有助于收敛
- 为什么 exploration 必须存在
- 为什么负奖励会向前传播

---

### 项目 2：CartPole + 调库 DQN / PPO
...
你这阶段先看 introduction 和 algorithm overview 就够。
...
- learning rate 的作用
- reward 抖动为什么出现
- exploration vs exploitation 是什么

如果这些你都能讲清楚，Phase 1 完成。
...
先读 arXiv 2013 版，不用先读 Nature 2015。
...
- 为什么 RL + NN 容易不稳定
- replay buffer 解决了什么
- target network 解决了什么
- 为什么 stack 4 frames
- 为什么 DQN 是 off-policy
- 为什么会出现 Q-value overestimation
