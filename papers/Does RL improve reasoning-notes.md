...
我觉得这篇论文最有价值的点，是它把模型做得更好和模型真的变强这两件事分开了。以前看 RL 提升推理，很容易直接把 benchmark 提升理解成能力提升，但这篇文章提醒我，很多时候提升的可能只是命中已有路径的效率，而不是产生了新的推理能力。这个区分对后面看 reasoning、agent 甚至 world model 的工作都很重要，因为它会直接影响我们怎么理解*能力增长*这件事。